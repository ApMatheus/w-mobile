...
export function New() {
    ...
    async function handleCreateNewHabit() {
        try {
            ...
            Alert.alert('Novo Hábito', 'Habíto Criado com sucesso!')
        } catch (error) {
            console.log(error);
    ...
    return (
        <View className="flex-1 bg-background px-8 pt-16">
            ...
            >
                ...
                <TextInput className="h-12 pl-4 rounded-lg mt-6 bg-zinc-900 text-white border-2  border-zinc-800 focus:border-green-600"
